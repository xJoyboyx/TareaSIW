...
<body>
    ...
    <div class="container">
        <div class="title pt-5">
            <h1>Llena todos los campos</h1>
            <br><br>
            
            <form method='POST' action='subir.php' name='formulario'>
                        
                <div class="form-group">
                    <label for="text-input">Título</label>
                    <input class="form-control" type="text"  name="title"  placeholder="Título del suceso" required>
                    </div>

                    <div class="form-group">
                    <label for="textarea-input">Descripción</label>
                    <textarea class="form-control"   name="description" rows="5" placeholder="Escribe una descripción del suceso" required></textarea>
                    </div>
                    ...
                    <?php 
                        PrintList("SELECT a.id, a.name, s.name as especie from animales a, specie s where a.specie_id = s.id;
                        ","responsable_id")
                    ?>
                    </div>
                </div>
            ...
            <button class='btn btn-primary' type='submit' href='subir.php'>Enviar</button>
            </form>
        </div>
    </div>
