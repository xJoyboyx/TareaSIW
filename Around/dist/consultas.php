...
<body>
    ...
    <div class="container">
        <div class="title pt-5">
            <h1>Mira los últimos incidentes</h1>
            <br><br>
            <!--Table-->
            <div class='table-responsive'>
                <table class='table table-dark'>
                    <?php DisplayTable("SELECT * FROM incidente_animal ORDER BY created_at DESC;",4, array("Título","Descripción","ID_ANIMAL","Última actualización"),true,true)?>
                </table>
            </div>
