...
<html lang="en">
  ...
  <body>
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <ul class="dropdown-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="./modificaciones.php">Editar</a></li>
            
                
                </ul>
                </li>
                <li class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="./consultas.php">Consultar </a></li>
            </ul>
            </li>
    ...
    <!-- zoo system presentation -->
    <div class="container pt-md-6">

    
    <div class="jumbotron bg-size-cover bg-position-center bg-no-repeat text-center" style="background-image: url(https://static.nationalgeographicla.com/files/styles/image_3200/public/rnr_stouffer_musicianwren.webp?w=1450&h=816);">
    <h1 class="text-light text-shadow">Bienvenid@ a Zoomanager</h1>
    <p class="lead text-light ">Aquí podrás administrar los incidentes de tu zoo</p>
    </div>
